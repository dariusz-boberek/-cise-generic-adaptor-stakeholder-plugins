...
//    profile.0.sea_basin=ArcticOcean
    ...
    public List<ServiceProfile> getConfiguredProfiles(ServiceRoleType profileServiceRoleType) {
        ...
        PullConsumerPluginConfig config;
    ...
    private ServiceProfile readProfileFrom(PullConsumerPluginConfig config, ServiceRoleType profileServiceRoleType) {
    ...
    private boolean isProfileNumDefined(PullConsumerPluginConfig config) {
    ...
    private PullConsumerPluginConfig createConfigNum(int i) {
        return ConfigFactory.create(PullConsumerPluginConfig.class, profileNumberKey(i));
    }
