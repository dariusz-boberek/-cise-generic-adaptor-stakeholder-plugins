...
class SubscribeConsumerPluginConfigTest {

    @Test
    void it_tests_valid_configuration() {
        SubscribeConsumerPluginConfig adaptorConfig = ConfigFactory.create(SubscribeConsumerPluginConfig.class);
        ...
        assertTrue(adaptorConfig.getHttpPort() > 0 && adaptorConfig.getHttpPort() < 65536);
