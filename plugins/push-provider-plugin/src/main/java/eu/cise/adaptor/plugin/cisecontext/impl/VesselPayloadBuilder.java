...
/**
 * This class manages all aspects of the creation of the CISE Payload to be sent to the CISE Network.
 * It contains two methods:
 * <ul>
 * <li>The implementation of Functional Interface to build the CISE Vessel class from the data provided by the CSV file</li>
 * <li>The building of the CISE payload using multiple instances of CISE Vessel</li>
 * </ul>
 */
