 ...
 */
@FunctionalInterface
public interface PushProviderDeliver {
     ...
     * @param recipientId The Service ID of the recipient
     ...
     */
    List<Pair<RegisteredMessage, Acknowledgement>> deliver(String referenceMessageId, String contextId, String recipientId, XmlEntityPayload payload) throws CiseAdaptorValidationException;
}
