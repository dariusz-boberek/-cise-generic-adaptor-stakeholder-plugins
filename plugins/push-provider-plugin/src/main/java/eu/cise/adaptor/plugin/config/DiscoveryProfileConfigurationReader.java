...
//    profile.0.sea_basin=ArcticOcean
    ...
    public List<ServiceProfile> getConfiguredProfiles(ServiceRoleType profileServiceRoleType) {
        ...
        PushProviderPluginConfig config;
    ...
    private ServiceProfile readProfileFrom(PushProviderPluginConfig config, ServiceRoleType profileServiceRoleType) {
    ...
    private boolean isProfileNumDefined(PushProviderPluginConfig config) {
    ...
    private PushProviderPluginConfig createConfigNum(int i) {
        return ConfigFactory.create(PushProviderPluginConfig.class, profileNumberKey(i));
    }
